...
<br>
    ...
    <h3>
      ...
      <h1 class="subheader">Inventory</h1>
        ...
        <br>
        <a class="primary-button" href="/ManageItems.php">Manage Items</a>
        ...
        <a class="primary-button" href="/ManageUnits.php">Manage Units</a>
        <a class="primary-button" href="/ViewTransactions.php">View Transactions</a>  
        <br>        
        <br>
